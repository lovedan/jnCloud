...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg">
                <img src="{{ URL::asset('asset/images/logo.png') }}" width="130">
            </span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">{{ $userinfos->user_nickname }}</span>
                        </a>
...
{{--                                    <small>生日：{{ $userinfos->birthday}}</small>--}}
                            ...
                            <li><!-- Task item -->
                                <a href="#">
                                    <h3>
                                        空间容量
                                        <small class="pull-right">{{ round(($capacity->capacity - $capacity->available)/1073741824,2).'G / '.round($capacity->capacity/1073741824,2).'G' }}</small>
                                    </h3>
                                    <div class="progress xs">
                                        <div class="progress-bar progress-bar-green" style="width: {{ round(($capacity->capacity - $capacity->available)/$capacity->capacity,2) * 100 }}%"
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="/tyhome"><i class="fa fa-dashboard"></i> 全部文件</a></li>
                @yield('menubar')
            </ol>
        </section>
